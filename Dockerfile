...
RUN wget http://search.maven.org/remotecontent?filepath=com/google/protobuf/protoc/3.0.0-beta-2/protoc-3.0.0-beta-2-linux-x86_64.exe -O /usr/local/bin/protoc && chmod +x /usr/local/bin/protoc
